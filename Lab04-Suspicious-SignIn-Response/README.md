...
As the IT administrator, I need to review the user’s sign-in activity, check for unusual login details, and take response actions to help secure the account.
...
## What I Learned
This lab helped me understand on responding to suspicious sign-in activity.
